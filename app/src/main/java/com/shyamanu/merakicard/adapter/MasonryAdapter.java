package com.shyamanu.merakicard.adapter;
...
import com.shyamanu.merakicard.activity.ProductDetailActivity;
...
public class MasonryAdapter extends RecyclerView.Adapter<MasonryAdapter.MasonryView> {
    ...
    private MyProductFragment context;
   ...
   /* int[] imgList = {R.drawable.two, R.drawable.one, R.drawable.three, R.drawable.four,
    ...
    public MasonryAdapter(MyProductFragment context) {
    ...
    public void onBindViewHolder(MasonryView holder, final int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent productDetailIntent = new Intent(context.getContext(), ProductDetailActivity.class);
                context.getContext().startActivity(productDetailIntent);
